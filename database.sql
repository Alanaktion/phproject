...
CREATE TABLE `issue_detail` (`id` int(10) unsigned, `status` int(11), `type_id` int(11) unsigned, `name` varchar(64), `description` text, `parent_id` int(11) unsigned, `author_id` int(11) unsigned, `owner_id` int(11) unsigned, `created_date` datetime, `closed_date` datetime, `deleted_date` datetime, `due_date` date, `repeat_cycle` enum('none','daily','weekly','monthly'), `sprint_id` int(10) unsigned, `type_name` varchar(32), `status_name` varchar(32), `status_closed` tinyint(1), `author_username` varchar(32), `author_name` varchar(32), `author_email` varchar(64), `author_task_color` char(6), `owner_username` varchar(32), `owner_name` varchar(32), `owner_email` varchar(64), `owner_task_color` char(6));
